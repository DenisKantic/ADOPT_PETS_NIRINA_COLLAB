  ...
  useEffect(()=>{
    ...
    return (
      ...
      <div className="w-[60%] mx-auto mt-10 text-center">
        ...
        <h1 className="text-[50px] text-center p-5 pb-10">Happy End</h1>
        <p className="text-xl text-center">At 'Happy End,' we believe that every dog deserves a chance at a happy and loving home. Our mission is to share heartwarming stories of dogs who have found their forever families, proving that adoption truly is a 'Happy End' for both the dogs and their new owners.
