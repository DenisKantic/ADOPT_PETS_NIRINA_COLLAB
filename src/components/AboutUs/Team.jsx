...
const Team = () => {
  return (
    ...
    <div className='w-full relative'>
        ...
        <h1 className='absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 text-center text-white
                      xss:text-[90px] md:text-[120px]'>OUR TEAM</h1>
    </div>
    ...
    <div className='flex justify-center flex-col items-center pt-5 w-auto'>
      ...
      <div className='w-[80%] flex flex-col items-center justify-center mt-[100px]'>
        <h1 className='xss:text-[30px] sm:text-[50px] pb-10'>CEO</h1>
        ...
        <h1 className='xss:text-[40px] sm:text-[50px] pb-5 mt-[100px]'>VOLUNTEERS</h1>
       <p className='xss:w-[90%] md:w-[70%] text-justify p-5'>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Ipsa excepturi laudantium assumenda molestias id porro numquam maxime veniam sed debitis!</p>
        </div>
      ...
      <div className='flex flex-col items-center p-5'>
        <h1 className='xss:text-[40px] sm:text-[50px] pb-5 mt-[100px]'>WORKERS</h1>
       <p className='xss:w-[90%] md:w-[70%] p-5 text-justify'>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Ipsa excepturi laudantium assumenda molestias id porro numquam maxime veniam sed debitis!</p>
        </div>
      ...
      <div className='flex flex-col items-center p-5 mt-[50px] text-center'>
      <h1 className='xss:w-[90%] xss:text-2xl sm:w-[70%] text-[35px]'>And special thanks to the guys who developed and maintaining our website for completely free. </h1>
      </div>
